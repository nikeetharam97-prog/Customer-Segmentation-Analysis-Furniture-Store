...
Custom segmentation using Python pandas- Each customer is scored on order frequency, total spend, discount rate and days since last purchase.
...
#Tools used:
Python (pandas, matplotlib, seaborn) · Google Colab · Excel

#Files
Colab notebook:
[Store_Customer_segmentation.ipynb](https://github.com/user-attachments/files/26355454/Store_Customer_segmentation.ipynb)

Customer with segment label:
[customer_segments.csv](https://github.com/user-attachments/files/26355467/customer_segments.csv)

Segmnet KPI comparison table:

[segment_profile_summary.csv](https://github.com/user-attachments/files/26355485/segment_profile_summary.csv)

#Dashboard preview:
<img width="2085" height="1520" alt="segmentation_charts" src="https://github.com/user-attachments/assets/585f10cd-56b1-4d47-9fbe-f77c27bd1ce6" />
